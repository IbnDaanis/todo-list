...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"helpers/stringToHTML.js":[function(require,module,exports) {
"use strict";
...
var _dateToday = require("../helpers/dateToday");
...
},{"../helpers/stringToHTML":"helpers/stringToHTML.js","../helpers/dateToday":"helpers/dateToday.js"}],"components/taskItem.js":[function(require,module,exports) {
"use strict";
...
var taskItem = function taskItem(data, DOM, currentProject, projects) {
  ...
  element.querySelector('h3').onclick = function () {
    DOM.unhide(element.querySelector("#addTaskFormContainer".concat(data.id)), 'hide');
  };
...
},{"../helpers/stringToHTML":"helpers/stringToHTML.js","./taskForm":"components/taskForm.js"}],"../node_modules/uuid/dist/esm-browser/rng.js":[function(require,module,exports) {
"use strict";
...
var Task = /*#__PURE__*/function () {
  ...
  _createClass(Task, [{
    key: "edit",
    value: function edit(title, description, priority, dueDate) {
      title && (this.title = title);
      description && (this.description = description);
      priority && (this.priority = priority);
      dueDate && (this.dueDate = dueDate);

      _AppData.AppData.save();
    }
  }, {
    key: "toggleComplete",
    value: function toggleComplete() {
      ...
      console.log(_AppData.AppData.projects);
    }
  }]);
...
exports.Task = Task;
},{"uuid":"../node_modules/uuid/dist/esm-browser/index.js","./AppData":"AppData.js","date-fns":"../node_modules/date-fns/esm/index.js"}],"Project.js":[function(require,module,exports) {
"use strict";
...
var Project = /*#__PURE__*/function () {
  ...
  _createClass(Project, [{
    ...
    value: function create() {
      ...
      _AppData.AppData.storeProject(this);
    }
  }, {
    key: "addTask",
...
},{"uuid":"../node_modules/uuid/dist/esm-browser/index.js","./AppData":"AppData.js"}],"AppData.js":[function(require,module,exports) {
"use strict";
...
var AppData = function () {
  ...
  var JSONtoClasses = function () {
    ...
    local && local.forEach(function (project) {
      ...
      project.tasks.forEach(function (task) {
        var newTask = new _Task.Task(task.title, task.description, task.priority, task.dueDate, task.isComplete, task.id);
        tasks.push(newTask);
      });
      var newProject = new _Project.Project(project.title, tasks, project.id, project.isDeleted, project.isActive);
  ...
  var removeProject = function removeProject(project) {
    var index = projects.findIndex(function (item) {
...
},{"./Task":"Task.js","./Project":"Project.js"}],"helpers/domNodes.js":[function(require,module,exports) {
"use strict";
...
var AppDOM = function () {
  ...
  var addProjectToSidebar = function addProjectToSidebar() {
    ...
    _AppData.AppData.projects.forEach(function (project) {
      var html = "<span id=title".concat(project.id, ">").concat(project.title, "</span><button id=delete").concat(project.id, ">X</button>");
      var projectEl = (0, _stringToHTML.stringToHTML)("".concat(html), 'li');

      projectEl.onclick = function (e) {
        if (e.target.id === "title".concat(project.id)) {
          console.log('AppDOM: ', project.id);
          AppDOM.addProjectToDashboard(project);
        } else if (e.target.id === "delete".concat(project.id)) {
  ...
  var addProjectsToTaskForm = function addProjectsToTaskForm(currentProject) {
    ...
    _AppData.AppData.projects.forEach(function (project) {
      projectSelection += "<option value=\"".concat(project.title, "\"\n      ").concat(currentProject.title === project.title && 'selected="selected"', "\n      >").concat(project.title, "</option>");
    });

    _domNodes.addTaskForm.projects.innerHTML = projectSelection;
  };

  var activeProject = function activeProject(current) {
    if (!current) {
      projectTitles.querySelectorAll('li').forEach(function (project) {
        return project.classList.remove('active');
      });
      return;
    }
...
_domNodes.addTaskForm.cancel.onclick = function () {
  AppDOM.unhide(_domNodes.addTaskForm.toggler);
  AppDOM.hide(_domNodes.addTaskForm.container);
};
